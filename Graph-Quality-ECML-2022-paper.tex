...
\input{adaptive-prolongation.tex}
\input{experiments-adaptive-prolongation.tex}
\input{coarsening-algorithms.tex}
\input{experiments-coarsening-algorithms.tex}
\input{conclusion.tex}

\begin{acknowledgments}
  The research reported in this paper has been supported by the Czech Science Foundation (GAČR) grant 18-18080S.\todo{Martin: Still relevant?}
\end{acknowledgments}
