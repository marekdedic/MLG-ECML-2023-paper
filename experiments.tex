...
\todo{R1: In the experiments, different characteristics of the dataset need to be presented : (1) dimensions of the original graph, (2) the value of the parameter L, (3) the dimensions of $G_i$ used in the training of $M_i$ (such as the used $M_9$, $M_6$, $M_3$). This allows one to compare the size of these compressed graphs with the original one.}
