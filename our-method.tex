...
In this work, we examine two ways of leveraging the graph structure to study the performance-complexity characteristics of the graph data. Firstly, we replace the simple prolongation approach by an adaptive prolongation algorithm. Secondly, we study two alternative ways of coarsening the graph.
