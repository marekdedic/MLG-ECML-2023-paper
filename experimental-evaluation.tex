...
\todo[inline]{Statistical significance testing}
...
\begin{table}
    ...
    \begin{tabularx}{\linewidth}{Xr}
        ...
        The edge whose incident nodes have the most similar features of their 1-hop neighbourhoods (under the Hausdorff distance)  &                        \\
        The edge whose incident nodes have the least similar features of their 1-hop neighbourhoods (under the Hausdorff distance) &                        \\
        \bottomrule
    \end{tabularx}
\end{table}
