...
\title[Adaptive graph coarsening in the context of local graph quality]{Adaptive graph coarsening in the context of local graph quality}% TODO: New name
...
\affil[3]{\orgdiv{Institute of Computer Science}, \orgname{Czech Academy of Sciences}, \orgaddress{\street{Pod vodárenskou věží 2}, \city{Prague}, \postcode{182 00}, \country{Czech Republic}}}
