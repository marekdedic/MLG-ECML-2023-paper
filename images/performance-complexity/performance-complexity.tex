...
\node[point] at (1,1) (p1) {}; \node[above of=p1, node distance=3ex] {G4};
\node[point] at (3,2) (p2) {}; \node[above of=p2, node distance=3ex] {G3};
\node[point] at (4,3) (p3) {}; \node[above of=p3, node distance=3ex] {G2};
\node[point] at (5,3.5) (p4) {}; \node[above of=p4, node distance=3ex] {G1};
\node[point] at (6,4) (p5) {}; \node[above of=p5, node distance=3ex] {G0};
